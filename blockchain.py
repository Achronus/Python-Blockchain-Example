...
#-------------------------
    ...
    def hash(block):
        ...
        block_string = json.dumps(block, sort_keys=True).encode() # .encode() returns a JSON string representation of the Python data structure (converts to a dictionary)
...
#-------------------------
    def resolve_conflicts(self):
        ...
        # Grad and verify the chains from all the nodes in our network
...
# Randomly, generate a globally unique address for this node
...
#---------------------------------------------------------
# Example of what the user sends to the server
#---------------------------------------------------------
"""
{
 "sender": "my address",
...
def consensus():
    ...
    if replaced:
        ...
        response = {
                'message': 'Our chain has no changes',
                'chain': blockchain.chain
                }
    return jsonify(response), 200
